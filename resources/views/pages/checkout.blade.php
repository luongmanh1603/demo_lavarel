                ...
                <div class="row">
                    <div class="col-lg-8 col-md-6">
                        <div class="checkout__input">
                            ...
                            <input name="full_name" value="{{auth()?auth()->user()->name:old("full_name")}}" type="text">                            @error("full_name")
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="checkout__input">
                                    <p>Email<span>*</span></p>
                                    <input value="{{auth()?auth()->user()->email:old("email")}}" name="email" type="email">                                    @error("email")
                                    <p class="text-danger"><i>{{$message}}</i></p>
                                    @enderror
                                </div>
                            </div>
                        ...
                        <div class="checkout__input__checkbox">
                            ...
                            <label for="acc">
                                Express
                                <input name="shipping_method" @if(old("shipping_method")== "Express") checked @endif value="Express" type="radio" id="acc">                                <span class="checkmark"></span>
                            </label>
                            <br/>
                            <label for="free">
                                Free Shipping
